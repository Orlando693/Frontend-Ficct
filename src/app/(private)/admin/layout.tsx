...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-dvh grid grid-cols-[260px_1fr] bg-slate-50">
      {/* SIDEBAR */}
      <aside className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 text-white p-4">
        {/* Header */}
