...
import { LayoutDashboard, LogOut, CalendarDays, ClipboardCheck, Menu, X } from "lucide-react"
...
export default function DocenteLayout() {
  const role = localStorage.getItem("role") || "Docente"
      ...
      <div className="lg:grid lg:grid-cols-[260px_minmax(0,1fr)]">
        ...
        >
          ...
          <nav className="mt-4 space-y-2 font-medium">
            <NavLink to="/docente" className={({isActive}) => `${linkBase} ${isActive ? linkActive : ""}`} onClick={() => setIsSidebarOpen(false)}>
